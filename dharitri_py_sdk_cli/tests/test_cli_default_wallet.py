...
from dharitri_py_sdk_cli.cli import main
...
def test_empty_wallet_config(capsys: Any, monkeypatch: Any, tmp_path: Path):
    ...
    import dharitri_py_sdk_cli.config_wallet

    monkeypatch.setattr(dharitri_py_sdk_cli.config_wallet, "LOCAL_WALLET_CONFIG_PATH", test_file)
    monkeypatch.setattr(dharitri_py_sdk_cli.config_wallet, "GLOBAL_WALLET_CONFIG_PATH", test_file)
    dharitri_py_sdk_cli.config_wallet.read_wallet_config_file.cache_clear()
